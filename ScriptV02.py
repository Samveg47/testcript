...
# Delete any existing tables in the target sheet
if target_sheet._tables:
    target_sheet._tables.clear()

# Convert data in the target sheet to a table
max_column = target_sheet.max_column
max_row_number = target_sheet.max_row
data_range = f"A1:{get_column_letter(max_column)}{max_row_number}"
